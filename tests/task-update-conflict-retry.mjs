...
assert.match(page,/supabase-firebase-compat\.js\?v=\d+\.\d+\.\d+/,'The compatibility bridge cache must be invalidated');
assert.match(html,/tasks-page\.js\?v=\d+\.\d+\.\d+/,'The task page cache must be invalidated');
