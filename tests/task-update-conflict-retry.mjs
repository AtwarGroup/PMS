...
assert.match(page,/supabase-firebase-compat\.js\?v=1\.9\.19/,'The compatibility bridge cache must be invalidated');
assert.match(html,/tasks-page\.js\?v=1\.9\.19/,'The task page cache must be invalidated');
