...
const page=read('job-library/index.html'),profile=read('profile/job-description.html');
...
assert.equal(data.jobs.length,46,'The reviewed library must contain 46 jobs');
assert.equal(new Set(data.jobs.map(x=>x.job_code)).size,46,'Job codes must be unique');
